...
'''def test_modificando_logradouro_do_cliente(criar_cliente):
    criar_cliente.logradouro == "cajacity"
    assert criar_cliente.logradouro == "tan"
def test_validando_logradouro_do_cliente(criar_cliente):
    assert criar_cliente.logradouro == "tan"'''

'''def test_modificando_numero_do_cliente(criar_cliente):
    criar_cliente.numero == 16
    assert criar_cliente.numero == 15
def test_validando_numero_do_cliente(criar_cliente):
    assert criar_cliente.numero == 15'''

'''def test_modificando_complemento_do_cliente(criar_cliente):
    criar_cliente.complemento == "apart"
    assert criar_cliente.complemento == "casa"
def test_validando_complemento_do_cliente(criar_cliente):
    assert criar_cliente.complemento == "casa"'''

'''def test_modificando_cep_do_cliente(criar_cliente):
    criar_cliente.cep == "422"
    assert criar_cliente.cep == "48598"
def test_validando_cep_do_cliente(criar_cliente):
    criar_cliente.cep == "56456"
    assert criar_cliente.cep == "48598"'''

#def test_modificando_cidade_do_cliente(criar_cliente):
#    criar_cliente.cidade == "perna"
#    assert criar_cliente.cidade == "salva"
#def test_validando_cidade_do_cliente(criar_cliente):
#    assert criar_cliente.cidade == "salva"
